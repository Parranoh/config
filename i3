...
bindsym       XF86MonBrightnessUp   exec brightnessctl set 50+ && $refresh_i3status &
bindsym       XF86MonBrightnessDown exec brightnessctl set 50- && $refresh_i3status &
bindsym Shift+XF86MonBrightnessUp   exec brightnessctl set  5+ && $refresh_i3status &
bindsym Shift+XF86MonBrightnessDown exec brightnessctl set  5- && $refresh_i3status &
